<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->umkm)
                        <x-nav-link :href="route('seller.umkm.edit')" :active="request()->routeIs('seller.umkm.*')">
                            {{ __('UMKM Saya') }}
                        </x-nav-link>
                    @else
                        <x-nav-link :href="route('seller.umkm.create')" :active="request()->routeIs('seller.umkm.create')">
                            {{ __('Daftar UMKM') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->umkm)
                <x-responsive-nav-link :href="route('seller.umkm.edit')" :active="request()->routeIs('seller.umkm.*')">
                    {{ __('UMKM Saya') }}
                </x-responsive-nav-link>
            @else
                <x-responsive-nav-link :href="route('seller.umkm.create')" :active="request()->routeIs('seller.umkm.create')">
                    {{ __('Daftar UMKM') }}
                </x-responsive-nav-link>
            @endif
