            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <label class="cursor-pointer">
                                ...
                                <div class="rounded-xl border-2 border-slate-200 p-4 peer-checked:border-indigo-600 peer-checked:bg-indigo-50 transition-all text-center">
                                    <img src="https://cdn.doku.com/doku-payment-gatewate-frontend/brand_guidelines/DOKU_Logo_Primary.png" alt="DOKU" class="h-6 mx-auto mb-2 grayscale peer-checked:grayscale-0 align-middle inline-block">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" required class="w-full rounded-xl border-slate-200 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="Contoh: 08123456789">
