                ...
                <div class="p-6"
                    ...
                    <form method="POST" action="{{ route('seller.shipping-zones.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select x-model="provinceId" @change="loadCities()"
                                ...
                                <div>
                                    ...
                                    <select x-model="cityId" @change="loadDistricts()" :disabled="!cities.length"
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 transition shadow-sm">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
