    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4">
                <form method="GET" action="{{ route('seller.products.index') }}" class="flex flex-col sm:flex-row gap-3 items-end">
                    <div class="flex-1 w-full">
                        <x-input-label for="search" :value="__('Cari')" class="mb-1" />
                        <x-text-input id="search" name="search" type="text" class="w-full" placeholder="Cari nama produk..."
