...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="/images/coffee-background.png"
            alt="coffee" />
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="flex flex-col items-center justify-center text-center">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            Selamat datang di KopiNgaji. Silakan Login atau Register untuk melanjutkan.
                        </p>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    &copy; <?php echo e(date('Y')); ?> KopiNgaji
                </footer>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Kopi_Ngaji_Project\KopiNgaji\resources\views\welcome.blade.php ENDPATH**/ ?>