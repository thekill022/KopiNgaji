    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-12">
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 mb-8 relative overflow-hidden transition-all hover:shadow-md group">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between">
                <div>
                    <h3 class="text-3xl font-extrabold text-slate-800 tracking-tight mb-2">Halo, <?php echo e(Auth::user()->name); ?>! 👋</h3>
                    <?php if($umkm): ?>
                    ...
                    <?php else: ?>
                        <div class="mt-4 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg inline-block">
                            <p class="text-amber-800 font-medium flex items-center gap-2">
                                ...
                                <?php echo e(__('Anda belum mendaftarkan UMKM. ')); ?>

                            </p>
                            <a href="<?php echo e(route('seller.umkm.create')); ?>" class="mt-3 inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded-full transition-all shadow-md hover:-translate-y-1">
                                <i class="fa-solid fa-plus-circle mr-2"></i> <?php echo e(__('Daftar Sekarang')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col items-center justify-center relative overflow-hidden group hover:-translate-y-1 transition-transform cursor-pointer">
                ...
                <div class="text-4xl font-extrabold text-slate-800">
                    <?php echo e($stats['product_count']); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col items-center justify-center relative overflow-hidden group hover:-translate-y-1 transition-transform cursor-pointer">
                ...
                <div class="text-4xl font-extrabold text-emerald-600">
                    <?php echo e($stats['completed_orders']); ?>
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl shadow-lg border border-emerald-400 p-6 flex flex-col items-center justify-center relative overflow-hidden group hover:-translate-y-1 transition-transform cursor-pointer col-span-1 md:col-span-2 lg:col-span-2">
                ...
                <div class="mt-4 w-full z-10 text-white">
                    <a href="<?php echo e(route('seller.withdrawals.index')); ?>" class="inline-block bg-white/20 hover:bg-white/30 text-sm font-bold py-2 px-4 rounded-full transition-colors backdrop-blur-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <a href="<?php echo e(route('seller.products.create')); ?>" class="flex items-center gap-6 p-6 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-3xl shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all">
            ...
            <a href="<?php echo e(route('seller.orders.index')); ?>" class="flex items-center gap-6 p-6 bg-gradient-to-r from-slate-700 to-slate-900 border border-slate-800 text-white rounded-3xl shadow-lg hover:-translate-y-1 hover:shadow-xl transition-all">
...
<?php endif; ?>
<?php /**PATH C:\Kopi_Ngaji_Project\KopiNgaji\resources\views\seller\dashboard.blade.php ENDPATH**/ ?>